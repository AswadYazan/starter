    ...
    <body>
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                <div class="links">
                    <a href="https://laravel.com/docs"><h1>{{__('messages.Docs')}}</h1></a>
                    ...
                    <a href="https://vapor.laravel.com">{{__('messages.Vapor')}}</a>
                    <a href="https://github.com/laravel/laravel">{{__('messages.GitHub')}}</a>
                    <a href="https://github.com/laravel/laravel">{{__('messages.GitHub')}}</a>
                    <a href="{{route('Y')}}">{{__('messages.normal_route')}}</a>
                    <a href="/users"> {{__('messages.controller')}}</a>
